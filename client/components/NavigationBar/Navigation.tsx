...
const Navigation = () => {
  ...
  const logOutClassName = `text-white no-underline border border-slate-300 rounded-sm  px-2 ml-3 ${
    userLoggedInstatus ? "visible" : "hidden"
  }`;

  const logoImageClassName = `kpImage border-0 border-sky-800   ${
    loggedInUserDetails !== null && "flex justify-center -mb-8"
  }`;
        ...
        <div className="col-span-7 md:col-span-6 border-0 border-purple-400 m-0 p-0 mr-3  ">
          <ul className="list-none flex space-x-2 md:space-x-6 text-white justify-end mt-2">
            ...
            <li className={loginClassName}>
              <Link href="/login" className="text-white no-underline px-1">
                Login
              </Link>
            </li>

            <li className={registerClassName}>
              <Link href="/register" className="text-white no-underline px-1 text-center ">
                Register
              </Link>
            </li>
            <li className={logOutClassName}>
              <button onClick={onLogOutClickHandler} className="text-white px-1 no-underline">
                Logout
              </button>
            </li>
          </ul>
      ...
      <div className=" relative">
        ...
        >
          <div className="border-0 border-white text-white max-w-7xl m-auto pt-14 ">
            ...
            <div
              className={`kpImage border-0 border-sky-800 hidden ${
                loggedInUserDetails !== null && "flex justify-center -mb-8"
              }`}
            >
              <Image
                src={
                  loggedInUserDetails !== null && loggedInUserDetails.profilePic
            ...
            <div className="text-white border-0 text-center pb-6 mt-11">
              ...
              <p className="text-white font-semibold text-xl capitalize underline underline-offset-4 decoration-1 decoration-slate-100">
